...
import { Upcoming_description } from "./Upcoming_description";
    ...
    <div className="relative w-screen">
      <Carousel className="w-full">
        <CarouselContent className="w-full">
          ...
          <CarouselItem>
            {" "}
            <img src={MovieData[1].image}></img>
          </CarouselItem>
          <CarouselItem>
            {" "}
            <Upcoming_description />
            <img src={MovieData[2].image}></img>
          </CarouselItem>
          <CarouselItem>
            {" "}
            <Upcoming_description />
            <img src={MovieData[3].image}></img>
          </CarouselItem>{" "}
          <CarouselItem>
            {" "}
            <Upcoming_description />
            <img src={MovieData[4].image}></img>
          </CarouselItem>
        </CarouselContent>
        <CarouselPrevious />
        <CarouselNext />
